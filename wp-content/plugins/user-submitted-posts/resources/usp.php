...
jQuery(document).ready(function ($) {
    ...
    if (re.test(location.href)) {
        $.removeCookie('user-submitted-name', {
            path: '/'
        });
        $.removeCookie('user-submitted-url', {
            path: '/'
        });
        $.removeCookie('user-submitted-title', {
            path: '/'
        });
        $.removeCookie('user-submitted-tags', {
            path: '/'
        });
        $.removeCookie('user-submitted-captcha', {
            path: '/'
        });
        $.removeCookie('user-submitted-category', {
            path: '/'
        });
        $.removeCookie('user-submitted-content', {
            path: '/'
        });
    }
    ...
    $('#usp_form').parsley({
        errors: {
            errorsWrapper: '<div class="usp-input-error"></div>',
            errorElem: '<span></span>'
        }
    });
