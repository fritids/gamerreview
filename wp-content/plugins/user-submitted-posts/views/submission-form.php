...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" data-validate="parsley" enctype="multipart/form-data" action="" novalidate>
		...
		<fieldset class="usp-tags">
			<label for="user-submitted-tags"><?php _e('Post Tags - Include game name!', 'usp'); ?></label>
			<input name="user-submitted-tags" id="user-submitted-tags" data-required="true" type="text" value="" placeholder="<?php _e('Tags separated by commas', 'usp'); ?>" class="usp-input">
		</fieldset>
